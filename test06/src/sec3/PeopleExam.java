...
public class PeopleExam {
	public static void main(String[] args) {
		...
		p1.selNum = 200; 
		// People.selNum = 200 와 동일 => 클래스 변수 == 정적 필드 == 공유 데이터
		p1.name = "김기태";
		// 인스턴스 변수 == 동적 필드	
		p1.age = 43;
		p1.addr = "가산동";
		...
		p2.selNum = 300;
		// People.selNum = 300와 동일 => 
		p2.name = "박동빈";
		p2.age = 45;
		p2.addr = "안암동";
		
		
		//System.out.println(p1.selNum + "," + p1.name); 순서는 상관없음
		...
		// 정적 요소 static으로 선언 된 필드 또는 메소드 , 객체의 생성없이 활용가능.
