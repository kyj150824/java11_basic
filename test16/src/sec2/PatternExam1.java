...
public class PatternExam1 {
	public static void main(String[] args) {
		String[] dt = {"bag", "kim1004", "9 to 6", "8 to 5", "single", "Mom", "ABC", "±è±âÅÂ"};
		// Pattern p = Pattern.compile("[a-z]*"); 
		// ¿µ¹® ¼Ò¹®ÀÚ·Î¸¸ ±¸¼ºµÈ µ¥ÀÌÅÍ
		// Pattern p = pattern.compile("{0-9a-z]*"); 
		// ¼ıÀÚ¿Í ¿µ¹® ¼Ò¹®ÀÚ·Î¸¸ ±¸¼ºµÈ µ¥ÀÌÅÍ
		// Pattern p = pattern.compile("[A-Za-z]*"); 
		// ¿µ¹® ´ë¹®ÀÚ ¶Ç´Â ¼Ò¹®ÀÚ·Î¸¸ ±¸¼ºµÈ µ¥ÀÌÅÍ
		// Pattern p = Pattern.compile("s[A-Za-z]"); 
		// s·Î ½ÃÀÛÇÏ¸é¼­ ¿µ¹® ´ë¹®ÀÚ ¶Ç´Â ¼Ò¹®ÀÚ·Î¸¸ ±¸¼ºµÈ µ¥ÀÌÅÍ.
		// Pattern p = Pattern.compile("[°¡-ÆR]"); 
		// ÇÑ±Û·Î¸¸ ±¸¼ºµÈ µ¥ÀÌÅÍ
		// Pattern p = Pattern.compile("e$");
		// Æ¯Á¤ ¹®ÀÚ·Î ³¡³ª´Â °æ¿ì ¹®ÀÚ µÚ¿¡ $
		// Pattern p = Pattern.compile("^b");
		// Æ¯Á¤ ¹®ÀÚ·Î ½ÃÀÛÇÏ´Â °æ¿ì ¹®ÀÚ ¾Õ¿¡ ^
		// Pattern p = Pattern.compile("[0-9]*"); ¶Ç´Â Pattern p = Pattern.compile("^[0-9]"); 
		// ¸ğµç °ªÀÌ ¼ıÀÚÀÎ µ¥ÀÌÅÍ
