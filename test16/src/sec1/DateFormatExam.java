...
// SimpleDateFormat : 날짜 표시형식을 지정할때 활용하는 클래스
public class DateFormatExam {
	public static void main(String[] args) {
			...
			SimpleDateFormat fmt3 = new SimpleDateFormat("오늘 날짜: yyyy년 MM월 dd일(E), 현재시각 hh시 mm분 ss초");
			SimpleDateFormat fmt4 = new SimpleDateFormat("오늘 날짜: yyyy년 M월 W번째 주");
			
			// 날짜 데이터에서 특정표시형식이 부여된 문자열로 변환
