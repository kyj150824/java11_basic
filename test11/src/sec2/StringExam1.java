...
public class StringExam1 {
	public static void main(String[] args) {
		...
		// 첫 번째 n의 글자 위치(인덱스)를 n 에 저장
		System.out.println("첫 번째 n의 글자 위치(인덱스)를 n 에 저장 : "+n);
		int n2 = data.lastIndexOf('n');	
		// 마지막 n의 글자 위치(인덱스)를 n 에 저장
		...
		// girl의 g의 마지막 위치부터 9 문자를 추출하여 저장
